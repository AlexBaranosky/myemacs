...
(fset 'alex_console_log
   (lambda (&optional arg) "Keyboard macro." (interactive "p") (kmacro-exec-ring-item (quote ([99 111 110 115 111 108 101 46 108 111 103 40 41 59 left left 34 34 left 58 58 32 right 44 32 left left left left left left] 0 "%d")) arg)))
